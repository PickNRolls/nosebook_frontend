...
export const CommentButton: React.FC<CommentButtonProps> = (props) => {
  return (
    <Button className="flex items-center gap-2" view="default" rounded="full" height="md" width="auto" px="sm" onClick={props.onClick}>
      ...
      {Boolean(props.count) && <span>{props.count}</span>}
    </Button>
  );
}
