import { createDeclineString } from "../declineString";

const declineSeconds = createDeclineString({
  1: 'секунду',
  2: 'секунды',
  5: 'секунд',
});

const declineMinutes = createDeclineString({
  1: 'минуту',
  2: 'минуты',
  5: 'минут',
});

const declineHours = createDeclineString({
  1: 'час',
  2: 'часа',
  5: 'часов',
});
